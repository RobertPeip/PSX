; PSX 'Bare Metal' Test
.psx
.create "DMAMDECOUT.bin", 0x80010000
...
SingleTest  test_RUNDMA    , TEXT_DMA_LEN    ,    3,  37,  37
SingleTest  test_RUNDMA    , TEXT_DMA_LEN    ,    4,  38,  38
SingleTest  test_RUNDMA    , TEXT_DMA_LEN    ,    5,  39,  39
SingleTest  test_RUNDMA    , TEXT_DMA_LEN    ,   10,  44,  44
SingleTest  test_RUNDMA    , TEXT_DMA_LEN    ,   16,  50,  50
SingleTest  test_RUNDMA    , TEXT_DMA_LEN    ,   32,  66,  66
...
SingleTest  test_RUNDMA    , TEXT_DMA_LEN    ,    1,  35,  35
SingleTest  test_RUNDMA    , TEXT_DMA_LEN    ,    2,  41,  41
SingleTest  test_RUNDMA    , TEXT_DMA_LEN    ,    3,  42,  42
