...
SingleTest  test_RUNDMA_IN    , TEXT_DMA_IN_LEN    ,    1,  35,  35
SingleTest  test_RUNDMA_IN    , TEXT_DMA_IN_LEN    ,    2,  36,  36
SingleTest  test_RUNDMA_IN    , TEXT_DMA_IN_LEN    ,    3,  37,  37
SingleTest  test_RUNDMA_IN    , TEXT_DMA_IN_LEN    ,    4,  38,  38
SingleTest  test_RUNDMA_IN    , TEXT_DMA_IN_LEN    ,    5,  39,  39
SingleTest  test_RUNDMA_IN    , TEXT_DMA_IN_LEN    ,   10,  44,  44
SingleTest  test_RUNDMA_IN    , TEXT_DMA_IN_LEN    ,   16,  50,  50
                                                               
SingleTest  test_RUNDMA_OUT   , TEXT_DMA_OUT_LEN   ,    1,  35,  35
SingleTest  test_RUNDMA_OUT   , TEXT_DMA_OUT_LEN   ,    2,  36,  36
SingleTest  test_RUNDMA_OUT   , TEXT_DMA_OUT_LEN   ,   16,  50,  50
...
SingleTest  test_RUNDMA_IN    , TEXT_DMA_IN_LEN    ,    1,  35,  35
SingleTest  test_RUNDMA_IN    , TEXT_DMA_IN_LEN    ,    2,  40,  40
SingleTest  test_RUNDMA_IN    , TEXT_DMA_IN_LEN    ,    3,  41,  41
                                                                   
SingleTest  test_RUNDMA_OUT   , TEXT_DMA_OUT_LEN   ,    1,  35,  35
SingleTest  test_RUNDMA_OUT   , TEXT_DMA_OUT_LEN   ,    3,  42,  42
