; PSX 'Bare Metal' MDEC DCT Block Decode CLUT 4BPP Demo by krom (Peter Lemon):
.psx
.create "DCTBlockDecodeCLUT4BPP.bin", 0x80010000
...
CopyRectCPU 512,256, 16,1 ; Copy Rectangle (CPU To VRAM): X,Y, Width,Height
...
DecodeMacroBlock 0,0,0,2,DCTA ; MDEC($01) - Decode Macroblock: Depth 4-Bit, Sign, Bit15, Word Size, RLE Quantized DCT Block

WAITMDECREADY

; Read Data/Response
ReadMDEC 8,TextureA8x8 ; MDEC - Read Data/Response: Data Read Word Size, RAM Output Address
...
; Decode DCT Macroblock
DecodeMacroBlock 0,0,0,2,DCTB ; MDEC($01) - Decode Macroblock: Depth 4-Bit, Sign, Bit15, Word Size, RLE Quantized DCT Block

WAITMDECREADY

; Read Data/Response
ReadMDEC 8,TextureB8x8 ; MDEC - Read Data/Response: Data Read Word Size, RAM Output Address

; Copy Texture To VRAM
CopyRectCPU 514,0, 2,8 ; Copy Rectangle (CPU To VRAM): X,Y, Width,Height
li t0,7 ; T0 = Data Copy Word Count
...
; Decode DCT Macroblock
DecodeMacroBlock 0,0,0,2,DCTC ; MDEC($01) - Decode Macroblock: Depth 4-Bit, Sign, Bit15, Word Size, RLE Quantized DCT Block

WAITMDECREADY

; Read Data/Response
ReadMDEC 8,TextureC8x8 ; MDEC - Read Data/Response: Data Read Word Size, RAM Output Address

; Copy Texture To VRAM
CopyRectCPU 516,0, 2,8 ; Copy Rectangle (CPU To VRAM): X,Y, Width,Height
li t0,7 ; T0 = Data Copy Word Count
...
; Decode DCT Macroblock
DecodeMacroBlock 0,0,0,3,DCTD ; MDEC($01) - Decode Macroblock: Depth 4-Bit, Sign, Bit15, Word Size, RLE Quantized DCT Block

WAITMDECREADY

; Read Data/Response
ReadMDEC 8,TextureD8x8 ; MDEC - Read Data/Response: Data Read Word Size, RAM Output Address

; Copy Texture To VRAM
CopyRectCPU 518,0, 2,8 ; Copy Rectangle (CPU To VRAM): X,Y, Width,Height
li t0,7 ; T0 = Data Copy Word Count
...
; Decode DCT Macroblock
DecodeMacroBlock 0,0,0,3,DCTE ; MDEC($01) - Decode Macroblock: Depth 4-Bit, Sign, Bit15, Word Size, RLE Quantized DCT Block

WAITMDECREADY

; Read Data/Response
ReadMDEC 8,TextureE8x8 ; MDEC - Read Data/Response: Data Read Word Size, RAM Output Address

; Copy Texture To VRAM
CopyRectCPU 520,0, 2,8 ; Copy Rectangle (CPU To VRAM): X,Y, Width,Height
li t0,7 ; T0 = Data Copy Word Count
...
; Decode DCT Macroblock
DecodeMacroBlock 0,0,0,2,DCTF ; MDEC($01) - Decode Macroblock: Depth 4-Bit, Sign, Bit15, Word Size, RLE Quantized DCT Block

WAITMDECREADY

; Read Data/Response
ReadMDEC 8,TextureF8x8 ; MDEC - Read Data/Response: Data Read Word Size, RAM Output Address

; Copy Texture To VRAM
CopyRectCPU 522,0, 2,8 ; Copy Rectangle (CPU To VRAM): X,Y, Width,Height
li t0,7 ; T0 = Data Copy Word Count
...
; Decode DCT Macroblock
DecodeMacroBlock 0,0,0,15,DCTG ; MDEC($01) - Decode Macroblock: Depth 4-Bit, Sign, Bit15, Word Size, RLE Quantized DCT Block

WAITMDECREADY

; Read Data/Response
ReadMDEC 8,TextureG8x8 ; MDEC - Read Data/Response: Data Read Word Size, RAM Output Address

; Copy Texture To VRAM
CopyRectCPU 524,0, 2,8 ; Copy Rectangle (CPU To VRAM): X,Y, Width,Height
li t0,7 ; T0 = Data Copy Word Count
...
CLUT:
  dh 0x0000,0x0842,0x1084,0x18C6,0x2108,0x294A,0x318C,0x39CE,0x4210,0x4A52,0x5294,0x5AD6,0x6318,0x6B5A,0x739C,0x7BDE ; 16x16B = 32 Bytes
