; PSX 'Bare Metal' CPU Bitwise Logical AND Immediate Test Demo by krom (Peter Lemon):
.psx
.create "CPUANDI.bin", 0x80010000
...
PrintString 8,24, 8,8, FontRed,ANDI,3 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
la a1,VALUEWORDA ; A1 = Word Data Offset
lw t0,0(a1)      ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
andi t0,IWORDB ; T0 = Test Word Data
...
lw t0,0(a1)      ; T0 = Word Data
la a1,ANDICHECKA ; A1 = Word Check Data Offset
...
lw t0,0(a1)      ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
andi t0,IWORDC ; T0 = Test Word Data
sw t0,0(a1) ; RDWORD = Word Data
...
la a1,RDWORD     ; A1 = Word Data Offset
lw t0,0(a1)      ; T0 = Word Data
la a1,ANDICHECKB ; A1 = Word Check Data Offset
lw t1,0(a1)      ; T1 = Word Check Data
nop ; Delay Slot
...
lw t0,0(a1)      ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
andi t0,IWORDD ; T0 = Test Word Data
sw t0,0(a1) ; RDWORD = Word Data
...
la a1,RDWORD     ; A1 = Word Data Offset
lw t0,0(a1)      ; T0 = Word Data
la a1,ANDICHECKC ; A1 = Word Check Data Offset
lw t1,0(a1)      ; T1 = Word Check Data
nop ; Delay Slot
...
lw t0,0(a1)       ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
andi t0,IWORDE ; T0 = Test Word Data
sw t0,0(a1) ; RDWORD = Word Data
...
la a1,RDWORD     ; A1 = Word Data Offset
lw t0,0(a1)      ; T0 = Word Data
la a1,ANDICHECKD ; A1 = Word Check Data Offset
lw t1,0(a1)      ; T1 = Word Check Data
nop ; Delay Slot
...
lw t0,0(a1)      ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
andi t0,IWORDF ; T0 = Test Word Data
sw t0,0(a1) ; RDWORD = Word Data
...
la a1,RDWORD     ; A1 = Word Data Offset
lw t0,0(a1)      ; T0 = Word Data
la a1,ANDICHECKE ; A1 = Word Check Data Offset
lw t1,0(a1)      ; T1 = Word Check Data
nop ; Delay Slot
...
lw t0,0(a1)      ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
andi t0,IWORDG ; T0 = Test Word Data
sw t0,0(a1) ; RDWORD = Word Data
...
la a1,RDWORD     ; A1 = Word Data Offset
lw t0,0(a1)      ; T0 = Word Data
la a1,ANDICHECKF ; A1 = Word Check Data Offset
lw t1,0(a1)      ; T1 = Word Check Data
nop ; Delay Slot
...
la a1,RDWORD     ; A1 = Word Data Offset
lw t0,0(a1)      ; T0 = Word Data
la a1,ANDICHECKG ; A1 = Word Check Data Offset
lw t1,0(a1)      ; T1 = Word Check Data
nop ; Delay Slot
