; PSX 'Bare Metal' CPU Bitwise Logical OR Test Demo by krom (Peter Lemon):
.psx
.create "CPUOR.bin", 0x80010000
...
PrintString 8,24, 8,8, FontRed,OR,1 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
...
lw t0,0(a1)    ; T0 = Word Data
la a1,ORCHECKA ; A1 = Word Check Data Offset
...
la a1,RDWORD   ; A1 = Word Data Offset
lw t0,0(a1)    ; T0 = Word Data
la a1,ORCHECKB ; A1 = Word Check Data Offset
lw t1,0(a1)    ; T1 = Word Check Data
nop ; Delay Slot
...
la a1,RDWORD   ; A1 = Word Data Offset
lw t0,0(a1)    ; T0 = Word Data
la a1,ORCHECKC ; A1 = Word Check Data Offset
lw t1,0(a1)    ; T1 = Word Check Data
nop ; Delay Slot
...
la a1,RDWORD   ; A1 = Word Data Offset
lw t0,0(a1)    ; T0 = Word Data
la a1,ORCHECKD ; A1 = Word Check Data Offset
lw t1,0(a1)    ; T1 = Word Check Data
nop ; Delay Slot
...
la a1,RDWORD   ; A1 = Word Data Offset
lw t0,0(a1)    ; T0 = Word Data
la a1,ORCHECKE ; A1 = Word Check Data Offset
lw t1,0(a1)    ; T1 = Word Check Data
nop ; Delay Slot
...
la a1,RDWORD   ; A1 = Word Data Offset
lw t0,0(a1)    ; T0 = Word Data
la a1,ORCHECKF ; A1 = Word Check Data Offset
lw t1,0(a1)    ; T1 = Word Check Data
nop ; Delay Slot
...
la a1,RDWORD   ; A1 = Word Data Offset
lw t0,0(a1)    ; T0 = Word Data
la a1,ORCHECKG ; A1 = Word Check Data Offset
lw t1,0(a1)    ; T1 = Word Check Data
nop ; Delay Slot
