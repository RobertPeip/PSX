; PSX 'Bare Metal' CPU Bitwise Logical EXCLUSIVE OR Immediate Test Demo by krom (Peter Lemon):
.psx
.create "CPUXORI.bin", 0x80010000
...
PrintString 8,24, 8,8, FontRed,XORI,3 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
la a1,VALUEWORDA ; A1 = Word Data Offset
lw t0,0(a1)      ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
xori t0,IWORDB ; T0 = Test Word Data
...
lw t0,0(a1)      ; T0 = Word Data
la a1,XORICHECKA ; A1 = Word Check Data Offset
...
lw t0,0(a1)      ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
xori t0,IWORDC ; T0 = Test Word Data
sw t0,0(a1) ; RDWORD = Word Data
...
la a1,RDWORD     ; A1 = Word Data Offset
lw t0,0(a1)      ; T0 = Word Data
la a1,XORICHECKB ; A1 = Word Check Data Offset
lw t1,0(a1)      ; T1 = Word Check Data
nop ; Delay Slot
...
lw t0,0(a1)      ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
xori t0,IWORDD ; T0 = Test Word Data
sw t0,0(a1) ; RDWORD = Word Data
...
la a1,RDWORD     ; A1 = Word Data Offset
lw t0,0(a1)      ; T0 = Word Data
la a1,XORICHECKC ; A1 = Word Check Data Offset
lw t1,0(a1)      ; T1 = Word Check Data
nop ; Delay Slot
...
lw t0,0(a1)       ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
xori t0,IWORDE ; T0 = Test Word Data
sw t0,0(a1) ; RDWORD = Word Data
...
la a1,RDWORD     ; A1 = Word Data Offset
lw t0,0(a1)      ; T0 = Word Data
la a1,XORICHECKD ; A1 = Word Check Data Offset
lw t1,0(a1)      ; T1 = Word Check Data
nop ; Delay Slot
...
lw t0,0(a1)      ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
xori t0,IWORDF ; T0 = Test Word Data
sw t0,0(a1) ; RDWORD = Word Data
...
la a1,RDWORD     ; A1 = Word Data Offset
lw t0,0(a1)      ; T0 = Word Data
la a1,XORICHECKE ; A1 = Word Check Data Offset
lw t1,0(a1)      ; T1 = Word Check Data
nop ; Delay Slot
...
lw t0,0(a1)      ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
xori t0,IWORDG ; T0 = Test Word Data
sw t0,0(a1) ; RDWORD = Word Data
...
la a1,RDWORD     ; A1 = Word Data Offset
lw t0,0(a1)      ; T0 = Word Data
la a1,XORICHECKF ; A1 = Word Check Data Offset
lw t1,0(a1)      ; T1 = Word Check Data
nop ; Delay Slot
...
la a1,RDWORD     ; A1 = Word Data Offset
lw t0,0(a1)      ; T0 = Word Data
la a1,XORICHECKG ; A1 = Word Check Data Offset
lw t1,0(a1)      ; T1 = Word Check Data
nop ; Delay Slot
