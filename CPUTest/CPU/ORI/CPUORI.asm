; PSX 'Bare Metal' CPU Bitwise Logical OR Immediate Test Demo by krom (Peter Lemon):
.psx
.create "CPUORI.bin", 0x80010000
...
PrintString 8,24, 8,8, FontRed,ORI,2 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
la a1,VALUEWORDA ; A1 = Word Data Offset
lw t0,0(a1)      ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
ori t0,IWORDB ; T0 = Test Word Data
...
lw t0,0(a1)     ; T0 = Word Data
la a1,ORICHECKA ; A1 = Word Check Data Offset
...
lw t0,0(a1)      ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
ori t0,IWORDC ; T0 = Test Word Data
sw t0,0(a1) ; RDWORD = Word Data
...
la a1,RDWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,ORICHECKB ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
...
lw t0,0(a1)      ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
ori t0,IWORDD ; T0 = Test Word Data
sw t0,0(a1) ; RDWORD = Word Data
...
la a1,RDWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,ORICHECKC ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
...
lw t0,0(a1)       ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
ori t0,IWORDE ; T0 = Test Word Data
sw t0,0(a1) ; RDWORD = Word Data
...
la a1,RDWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,ORICHECKD ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
...
lw t0,0(a1)      ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
ori t0,IWORDF ; T0 = Test Word Data
sw t0,0(a1) ; RDWORD = Word Data
...
la a1,RDWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,ORICHECKE ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
...
lw t0,0(a1)      ; T0 = Word Data
la a1,RDWORD ; A1 = RDWORD Offset
ori t0,IWORDG ; T0 = Test Word Data
sw t0,0(a1) ; RDWORD = Word Data
...
la a1,RDWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,ORICHECKF ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
...
la a1,RDWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,ORICHECKG ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
