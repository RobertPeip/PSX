; PSX 'Bare Metal' CPU Load Byte Test Demo by krom (Peter Lemon):
.psx
.create "CPULB.bin", 0x80010000
...
; Print Header Text
PrintString  40,8, 8,8, FontRed,BYTEHEX,7 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
PrintString 128,8, 8,8, FontRed,BYTEDEC,7 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
...
PrintString 8,24, 8,8, FontRed,LB,1 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
...
la a1,LBCHECKA ; A1 = Word Check Data Offset
...
la a1,RTWORD   ; A1 = Word Data Offset
lw t0,0(a1)    ; T0 = Word Data
la a1,LBCHECKB ; A1 = Word Check Data Offset
lw t1,0(a1)    ; T1 = Word Check Data
nop ; Delay Slot
...
la a1,RTWORD   ; A1 = Word Data Offset
lw t0,0(a1)    ; T0 = Word Data
la a1,LBCHECKC ; A1 = Word Check Data Offset
lw t1,0(a1)    ; T1 = Word Check Data
nop ; Delay Slot
...
la a1,RTWORD   ; A1 = Word Data Offset
lw t0,0(a1)    ; T0 = Word Data
la a1,LBCHECKD ; A1 = Word Check Data Offset
lw t1,0(a1)    ; T1 = Word Check Data
nop ; Delay Slot
...
la a1,RTWORD   ; A1 = Word Data Offset
lw t0,0(a1)    ; T0 = Word Data
la a1,LBCHECKE ; A1 = Word Check Data Offset
lw t1,0(a1)    ; T1 = Word Check Data
nop ; Delay Slot
...
la a1,RTWORD   ; A1 = Word Data Offset
lw t0,0(a1)    ; T0 = Word Data
la a1,LBCHECKF ; A1 = Word Check Data Offset
lw t1,0(a1)    ; T1 = Word Check Data
nop ; Delay Slot
...
la a1,RTWORD   ; A1 = Word Data Offset
lw t0,0(a1)    ; T0 = Word Data
la a1,LBCHECKG ; A1 = Word Check Data Offset
lw t1,0(a1)    ; T1 = Word Check Data
nop ; Delay Slot
...
PrintString 8,88, 8,8, FontRed,LBU,2 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
la a1,VALUEBYTEA ; A1 = Byte Data Offset
lbu t0,0(a1)     ; T0 = Test Byte Data
la a1,RTWORD ; A1 = RTWORD Offset
sw t0,0(a1)  ; RTWORD = Word Data
PrintString 40,88, 8,8, FontBlack,DOLLAR,0 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
PrintValue  48,88, 8,8, FontBlack,VALUEBYTEA,0 ; Print HEX Chars To VRAM Using Width,Height Font At X,Y Position
PrintString 184,88, 8,8, FontBlack,TEXTBYTEA,0 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
...
la a1,RTWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,LBUCHECKA ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
...
PrintValue  48,96, 8,8, FontBlack,VALUEBYTEB,0 ; Print HEX Chars To VRAM Using Width,Height Font At X,Y Position
PrintString 184,96, 8,8, FontBlack,TEXTBYTEB,0 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
...
la a1,RTWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,LBUCHECKB ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
...
PrintValue  48,104, 8,8, FontBlack,VALUEBYTEC,0 ; Print HEX Chars To VRAM Using Width,Height Font At X,Y Position
PrintString 176,104, 8,8, FontBlack,TEXTBYTEC,1 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
...
la a1,RTWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,LBUCHECKC ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
...
PrintValue  48,112, 8,8, FontBlack,VALUEBYTED,0 ; Print HEX Chars To VRAM Using Width,Height Font At X,Y Position
PrintString 168,112, 8,8, FontBlack,TEXTBYTED,2 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
...
la a1,RTWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,LBUCHECKD ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
...
PrintValue  48,120, 8,8, FontBlack,VALUEBYTEE,0 ; Print HEX Chars To VRAM Using Width,Height Font At X,Y Position
PrintString 176,120, 8,8, FontBlack,TEXTBYTEE,1 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
...
la a1,RTWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,LBUCHECKE ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
...
PrintValue  48,128, 8,8, FontBlack,VALUEBYTEF,0 ; Print HEX Chars To VRAM Using Width,Height Font At X,Y Position
PrintString 168,128, 8,8, FontBlack,TEXTBYTEF,2 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
...
la a1,RTWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,LBUCHECKF ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
...
PrintValue  48,136, 8,8, FontBlack,VALUEBYTEG,0 ; Print HEX Chars To VRAM Using Width,Height Font At X,Y Position
PrintString 160,136, 8,8, FontBlack,TEXTBYTEG,3 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
...
la a1,RTWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,LBUCHECKG ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
