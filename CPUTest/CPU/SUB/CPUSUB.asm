; PSX 'Bare Metal' CPU Signed Word Subtraction Test Demo by krom (Peter Lemon):
.psx
.create "CPUSUB.bin", 0x80010000
...
PrintString 8,24, 8,8, FontRed,SUB,2 ; Print Text String To VRAM Using Width,Height Font At X,Y Position
...
lw t0,0(a1)     ; T0 = Word Data
la a1,SUBCHECKA ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
beq t0,t1,SUBPASSA ; Compare Result Equality With Check Data
nop ; Delay Slot
...
la a1,RDWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,SUBCHECKB ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
beq t0,t1,SUBPASSB ; Compare Result Equality With Check Data
nop ; Delay Slot
...
la a1,RDWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,SUBCHECKC ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
beq t0,t1,SUBPASSC ; Compare Result Equality With Check Data
nop ; Delay Slot
...
la a1,RDWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,SUBCHECKD ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
beq t0,t1,SUBPASSD ; Compare Result Equality With Check Data
nop ; Delay Slot
...
la a1,RDWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,SUBCHECKE ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
beq t0,t1,SUBPASSE ; Compare Result Equality With Check Data
nop ; Delay Slot
...
la a1,RDWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,SUBCHECKF ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
beq t0,t1,SUBPASSF ; Compare Result Equality With Check Data
nop ; Delay Slot
...
la a1,RDWORD    ; A1 = Word Data Offset
lw t0,0(a1)     ; T0 = Word Data
la a1,SUBCHECKG ; A1 = Word Check Data Offset
lw t1,0(a1)     ; T1 = Word Check Data
nop ; Delay Slot
beq t0,t1,SUBPASSG ; Compare Result Equality With Check Data
nop ; Delay Slot
