; PSX 'Bare Metal' Test
.psx
.create "ExtBusDelay.bin", 0x80010000
...
; tests
MultiTest TEXT_OFF_S_1, test_1SB,   test_1SH,   test_1SW,      9,    9,    9
MultiTest TEXT_OFF_S_2, test_2SB,   test_2SH,   test_2SW,     13,   16,   22
MultiTest TEXT_OFF_S_3, test_3SB,   test_3SH,   test_3SW,     17,   23,   35
MultiTest TEXT_OFF_S_4, test_4SB,   test_4SH,   test_4SW,     21,   30,   48
        
MultiTest TEXT_OFF_L_1, test_1LB,   test_1LH,   test_1LW,     14,   18,   26
MultiTest TEXT_OFF_L_2, test_2LB,   test_2LH,   test_2LW,     22,   30,   46
MultiTest TEXT_OFF_L_3, test_3LB,   test_3LH,   test_3LW,     30,   42,   66
MultiTest TEXT_OFF_L_4, test_4LB,   test_4LH,   test_4LW,     38,   54,   86

MultiTest TEXT_OFF_SL,  test_1SBLB, test_1SHLH, test_1SWLW,   18,   25,   39
...
TEXT_TEST1:                      .db "MEMCTRL=00000000 WDELAY=0 RDELAY=0",0
TEXT_TEST2:                      .db "MEMCTRL=00000021 WDELAY=1 RDELAY=2",0
