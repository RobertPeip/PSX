; PSX 'Bare Metal' Test
.psx
.create "ExtBusFloatRelease.bin", 0x80010000
...
; FREL of 0 = no effect
; FREL of 1 = +1 cycle for 16/32bit reads
; FREL of 4 = +1 cycle for subsequent reads, +4 cycles for 16/32bit reads
; FREL has no effect on any write
...
MultiTest TEXT_OFF_L_1, test_1LB,   test_1LH,   test_1LW,     12,   19,   33
MultiTest TEXT_OFF_L_2, test_2LB,   test_2LH,   test_2LW,     20,   34,   62
MultiTest TEXT_OFF_L_3, test_3LB,   test_3LH,   test_3LW,     28,   49,   91
MultiTest TEXT_OFF_L_4, test_4LB,   test_4LH,   test_4LW,     36,   64,  120

MultiTest TEXT_OFF_SL,  test_1SBLB, test_1SHLH, test_1SWLW,   15,   24,   42
...
TEXT_TEST1:                      .db "MEMCTRL=00000400 COM_DELAY=0000 FREL=0",0
TEXT_TEST2:                      .db "MEMCTRL=00000400 COM_DELAY=0500 FREL=5",0
