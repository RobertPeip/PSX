; PSX 'Bare Metal' Test
.psx
.create "ExtBusBusWidth.bin", 0x80010000
...
; autoincrement has no influence on any bus width, not matter if com0-3 periods are used or not
...
; tests
MultiTest TEXT_OFF_S_1, test_1SB,   test_1SH,   test_1SW,      9,    9,    9
MultiTest TEXT_OFF_S_2, test_2SB,   test_2SH,   test_2SW,     12,   12,   14
MultiTest TEXT_OFF_S_3, test_3SB,   test_3SH,   test_3SW,     15,   15,   19
MultiTest TEXT_OFF_S_4, test_4SB,   test_4SH,   test_4SW,     18,   18,   24
                                                                 
MultiTest TEXT_OFF_L_1, test_1LB,   test_1LH,   test_1LW,     12,   12,   14
MultiTest TEXT_OFF_L_2, test_2LB,   test_2LH,   test_2LW,     18,   18,   22
MultiTest TEXT_OFF_L_3, test_3LB,   test_3LH,   test_3LW,     24,   24,   30
MultiTest TEXT_OFF_L_4, test_4LB,   test_4LH,   test_4LW,     30,   30,   38
                                                                 
MultiTest TEXT_OFF_SL,  test_1SBLB, test_1SHLH, test_1SWLW,   15,   15,   19
...
TEXT_TEST1:                      .db "MEMCTRL=00001000 WIDTH=8",0
TEXT_TEST2:                      .db "MEMCTRL=00001000 WIDTH=16",0
