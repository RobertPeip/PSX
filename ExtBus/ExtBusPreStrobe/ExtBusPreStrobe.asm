; PSX 'Bare Metal' Test
.psx
.create "ExtBusPreStrobe.bin", 0x80010000
...
; PSTR of 0 = no effect
; PSTR of n = +n cycles for everything
...
MultiTest TEXT_OFF_L_1, test_1LB,   test_1LH,   test_1LW,     17,   24,   38
MultiTest TEXT_OFF_L_2, test_2LB,   test_2LH,   test_2LW,     28,   42,   70
MultiTest TEXT_OFF_L_3, test_3LB,   test_3LH,   test_3LW,     39,   60,  102
MultiTest TEXT_OFF_L_4, test_4LB,   test_4LH,   test_4LW,     50,   78,  134

MultiTest TEXT_OFF_SL,  test_1SBLB, test_1SHLH, test_1SWLW,   25,   39,   67
...
TEXT_TEST1:                      .db "MEMCTRL=00000800 COM_DELAY=0000 PSTR=0",0
TEXT_TEST2:                      .db "MEMCTRL=00000800 COM_DELAY=5000 PSTR=5",0
