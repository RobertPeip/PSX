; PSX 'Bare Metal' Test
.psx
.create "ExtBusRecovery.bin", 0x80010000
...
; recovery of 0+1 behaves as if off
; recovery of 2 behaves as 1 for write and 16/32bit reads
; recovery of 5 behaves as 1 for subsequent reads
...
li s1, 0x0005 
sw s1,COM_DELAY(a0)
PrintText 20,s6,TEXT_TEST2
addiu s6,10

; tests
MultiTest TEXT_OFF_S_1, test_1SB,   test_1SH,   test_1SW,      9,    9,    9
MultiTest TEXT_OFF_S_2, test_2SB,   test_2SH,   test_2SW,     12,   18,   30
MultiTest TEXT_OFF_S_3, test_3SB,   test_3SH,   test_3SW,     19,   31,   55
MultiTest TEXT_OFF_S_4, test_4SB,   test_4SH,   test_4SW,     26,   44,   80
        
MultiTest TEXT_OFF_L_1, test_1LB,   test_1LH,   test_1LW,     12,   18,   30
MultiTest TEXT_OFF_L_2, test_2LB,   test_2LH,   test_2LW,     19,   31,   55
MultiTest TEXT_OFF_L_3, test_3LB,   test_3LH,   test_3LW,     26,   44,   80
MultiTest TEXT_OFF_L_4, test_4LB,   test_4LH,   test_4LW,     33,   57,  105

MultiTest TEXT_OFF_SL,  test_1SBLB, test_1SHLH, test_1SWLW,   19,   31,   55
...
TEXT_TEST1:                      .db "MEMCTRL=00000100 COM_DELAY=0001 REC=1",0
TEXT_TEST2:                      .db "MEMCTRL=00000100 COM_DELAY=0005 REC=5",0
