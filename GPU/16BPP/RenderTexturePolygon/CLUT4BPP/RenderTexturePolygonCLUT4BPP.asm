; PSX 'Bare Metal' GPU 16BPP Render Texture Polygon CLUT 4BPP Demo by krom (Peter Lemon):
.psx
.create "RenderTexturePolygonCLUT4BPP.bin", 0x80010000
...
TexTriRaw 24,8, 0,0, 0x4020, 32,8, 8,0, 0x008, 24,16, 0,8  ; Texture Triangle Raw: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3
TexTriRaw 32,8, 8,0, 0x4020, 32,16, 8,8, 0x008, 24,16, 0,8 ; Texture Triangle Raw: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3

TexTriRaw 112,8, 8,0, 0x4020, 128,8, 24,0, 0x008, 112,24, 8,16    ; Texture Triangle Raw: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3
TexTriRaw 128,8, 24,0, 0x4020, 128,24, 24,16, 0x008, 112,24, 8,16 ; Texture Triangle Raw: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3

TexTriRaw 192,8, 24,0, 0x4020, 224,8, 56,0, 0x008, 192,40, 24,32   ; Texture Triangle Raw: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3
TexTriRaw 224,8, 56,0, 0x4020, 224,40, 56,32, 0x008, 192,40, 24,32 ; Texture Triangle Raw: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3

TexTriRawAlpha 24,12, 0,0, 0x4020, 32,12, 8,0, 0x008, 24,20, 0,8 ; Texture Triangle Raw Alpha: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3
TexTriRawAlpha 32,12, 8,0, 0x4020, 32,20, 8,8, 0x008, 24,20, 0,8 ; Texture Triangle Raw Alpha: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3

TexTriRawAlpha 112,16, 8,0, 0x4020, 128,16, 24,0, 0x008, 112,32, 8,16   ; Texture Triangle Raw Alpha: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3
TexTriRawAlpha 128,16, 24,0, 0x4020, 128,32, 24,16, 0x008, 112,32, 8,16 ; Texture Triangle Raw Alpha: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3

TexTriRawAlpha 192,24, 24,0, 0x4020, 224,24, 56,0, 0x008, 192,56, 24,32  ; Texture Triangle Raw Alpha: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3
TexTriRawAlpha 224,24, 56,0, 0x4020, 224,56, 56,32, 0x008, 192,56, 24,32 ; Texture Triangle Raw Alpha: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3

TexTriBlend 0x0000FF, 64,8, 88,0, 0x4020, 96,56, 120,64, 0x008, 32,56, 56,64    ; Texture Triangle Blend: Color, X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3
TexTriBlend 0x00FF00, 160,8, 88,0, 0x4020, 192,56, 120,64, 0x008, 128,56, 56,64 ; Texture Triangle Blend: Color, X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3
TexTriBlend 0xFF0000, 256,8, 88,0, 0x4020, 288,56, 120,64, 0x008, 224,56, 56,64 ; Texture Triangle Blend: Color, X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3

TexTriBlendAlpha 0x00FF00, 64,32, 88,0, 0x4020, 96,80, 120,64, 0x008, 32,80, 56,64    ; Texture Triangle Blend Alpha: Color, X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3
TexTriBlendAlpha 0xFF0000, 160,32, 88,0, 0x4020, 192,80, 120,64, 0x008, 128,80, 56,64 ; Texture Triangle Blend Alpha: Color, X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3
TexTriBlendAlpha 0x0000FF, 256,32, 88,0, 0x4020, 288,80, 120,64, 0x008, 224,80, 56,64 ; Texture Triangle Blend Alpha: Color, X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3

TexQuadRaw 24,88, 0,0, 0x4020, 32,88, 8,0, 0x008, 24,96, 0,8, 32,96, 8,8             ; Texture Quad Raw: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3, X4,Y4, U4,V4
TexQuadRaw 112,88, 8,0, 0x4020, 128,88, 24,0, 0x008, 112,104, 8,16, 128,104, 24,16   ; Texture Quad Raw: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3, X4,Y4, U4,V4
TexQuadRaw 192,88, 24,0, 0x4020, 224,88, 56,0, 0x008, 192,120, 24,32, 224,120, 56,32 ; Texture Quad Raw: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3, X4,Y4, U4,V4

TexQuadRawAlpha 24,92, 0,0, 0x4020, 32,92, 8,0, 0x008, 24,100, 0,8, 32,100, 8,8             ; Texture Quad Raw Alpha: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3, X4,Y4, U4,V4
TexQuadRawAlpha 112,96, 8,0, 0x4020, 128,96, 24,0, 0x008, 112,112, 8,16, 128,112, 24,16     ; Texture Quad Raw Alpha: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3, X4,Y4, U4,V4
TexQuadRawAlpha 192,104, 24,0, 0x4020, 224,104, 56,0, 0x008, 192,136, 24,32, 224,136, 56,32 ; Texture Quad Raw Alpha: X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3, X4,Y4, U4,V4

TexQuadBlend 0x0000FF, 32,88, 56,0, 0x4020, 80,88, 120,0, 0x008, 32,136, 56,64, 80,136, 120,64     ; Texture Quad Blend: Color, X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3, X4,Y4, U4,V4
TexQuadBlend 0x00FF00, 128,88, 56,0, 0x4020, 176,88, 120,0, 0x008, 128,136, 56,64, 176,136, 120,64 ; Texture Quad Blend: Color, X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3, X4,Y4, U4,V4
TexQuadBlend 0xFF0000, 224,88, 56,0, 0x4020, 272,88, 120,0, 0x008, 224,136, 56,64, 272,136, 120,64 ; Texture Quad Blend: Color, X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3, X4,Y4, U4,V4

TexQuadBlendAlpha 0x00FF00, 48,94, 56,0, 0x4020, 96,94, 120,0, 0x008, 48,142, 56,64, 96,142, 120,64     ; Texture Quad Blend Alpha: Color, X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3, X4,Y4, U4,V4
TexQuadBlendAlpha 0xFF0000, 144,94, 56,0, 0x4020, 192,94, 120,0, 0x008, 144,142, 56,64, 192,142, 120,64 ; Texture Quad Blend Alpha: Color, X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3, X4,Y4, U4,V4
TexQuadBlendAlpha 0x0000FF, 240,94, 56,0, 0x4020, 288,94, 120,0, 0x008, 240,142, 56,64, 288,142, 120,64 ; Texture Quad Blend Alpha: Color, X1,Y1, U1,V1, PAL, X2,Y2, U2,V2, TEX, X3,Y3, U3,V3, X4,Y4, U4,V4

ShadeTexTri 0x0000FF,64,148, 88,0, 0x4020, 0x00FF00,96,196, 120,64, 0x008, 0xFF0000,32,196, 56,64 ; Shaded Texture Triangle: Color1,X1,Y1, U1,V1, PAL, Color2,X2,Y2, U2,V2, TEX, Color3,X3,Y3, U3,V3

ShadeTexTriAlpha 0x00FF00,80,154, 88,0, 0x4020, 0xFF0000,112,202, 120,64, 0x008, 0x0000FF,48,202, 56,64 ; Shaded Texture Triangle Alpha: Color1,X1,Y1, U1,V1, PAL, Color2,X2,Y2, U2,V2, TEX, Color3,X3,Y3, U3,V3

ShadeTexQuad 0x0000FF,224,148, 56,0, 0x4020, 0x00FF00,272,148, 120,0, 0x008, 0xFF0000,224,196, 56,64, 0xFF00FF,272,196, 120,64 ; Shaded Texture Quad: Color1,X1,Y1, U1,V1, PAL, Color2,X2,Y2, U2,V2, TEX, Color3,X3,Y3, U3,V3, Color4,X4,Y4, U4,V4

ShadeTexQuadAlpha 0x00FF00,240,154, 56,0, 0x4020, 0xFF00FF,288,154, 120,0, 0x008, 0x0000FF,240,202, 56,64, 0xFF0000,288,202, 120,64 ; Shaded Texture Quad Alpha: Color1,X1,Y1, U1,V1, PAL, Color2,X2,Y2, U2,V2, TEX, Color3,X3,Y3, U3,V3, Color4,X4,Y4, U4,V4
